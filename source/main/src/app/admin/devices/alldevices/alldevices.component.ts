...
import {DevicesService} from "../../devices/alldevices/devices.service";
...
export class AlldevicesComponent extends
  ...
  exampleDatabase: DevicesService | null;
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.exampleDatabase.dataChange.value.unshift(
          this.devicesService.getDialogData()
        );
        this.refreshTable();
  ...
  public loadData() {
    this.exampleDatabase = new DevicesService(this.httpClient);
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        case "id":
          ...
          break;
        case "idDevice":
          [propertyA, propertyB] = [a.idDevice, b.idDevice];
          break;
        case "temperature":
          [propertyA, propertyB] = [a.temperature, b.temperature];
          break;
        case "flow":
          [propertyA, propertyB] = [a.flow, b.flow];
          break;
        case "fio2":
          [propertyA, propertyB] = [a.fio2, b.fio2];
          break;
        case "spo2":
          [propertyA, propertyB] = [a.spo2, b.spo2];
          break;
        case "isWorkingProperly":
          [propertyA, propertyB] = [a.isWorkingProperly, b.isWorkingProperly];
          break;
        case "isConnected":
          [propertyA, propertyB] = [a.isConnected, b.isConnected];
          break;
        case "lastRefreshed":
          [propertyA, propertyB] = [a.lastRefreshed, b.lastRefreshed];
          break;
      }
